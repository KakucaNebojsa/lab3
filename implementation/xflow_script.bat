...
@REM #
ngdbuild -p xc6slx45fgg676-2 -nt timestamp -bm HelloWorld.bmm "C:/Users/student/Desktop/RA147/lab3/lab3/implementation/HelloWorld.ngc" -uc HelloWorld.ucf HelloWorld.ngd 
